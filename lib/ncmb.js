(function(global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['es6-promise'], function(ES6Promise) {
      return factory(ES6Promise);
    });
  } else if (typeof exports !== 'undefined') {
    exports = factory(require('es6-promise'));
  } else {
    global.NCMB = factory(global.ES6Promise);
  }
})(typeof window !== 'undefined' ? window : this, function(ES6Promise) {
  "use strict";
